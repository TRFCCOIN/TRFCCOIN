#############################################################################
# Makefile for building: TrafficCoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: ?? ?? 25 19:53:47 2014
# Project:  TrafficCoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile TrafficCoin-qt.pro
#############################################################################
...
Makefile: TrafficCoin-qt.pro  ../QT/4.8.5/mkspecs/default/qmake.conf ../QT/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile TrafficCoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/TrafficCoin-master/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/TrafficCoin-master/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/TrafficCoin-master/src/leveldb/libleveldb.a: FORCE
