...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("TrafficCoin-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TrafficCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"115.47.44.19", "115.47.44.19"},
    {"23.27.112.135", "23.27.112.135"},
	{"103.243.25.161", "103.243.25.161"},
};
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("TrafficCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("TrafficCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("TrafficCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("TrafficCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TrafficCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("TrafficCoin-start");
